...
namespace ga_forms.Views
{
    ...
    public partial class DecorateSelectionPage : ContentPage
    {
        // Bitmaps
        ...
        private readonly DecorateSelectionViewModel _viewModel;

        // Ctor
        public DecorateSelectionPage()
        {
            InitializePaints();
            InitializeComponent();
            BindingContext = DependencyInjectionManager.ServiceProvider.GetService<DecorateSelectionViewModel>();
            _viewModel = (DecorateSelectionViewModel)BindingContext;
        ...
        private void ImportHealthImage()
        {
            try
            {
                _backgroundBitmap = (BindingContext as DecorateSelectionViewModel)?.GetCapturedImageBitmap();
            }
            catch (Exception e)
            {
