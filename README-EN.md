...
year of Computer Science college from University of Transilvania Brasov for Mobile Applications Development
and Image Processing subjects.

The application is an mobile assistant for maintenance and embellishment of the garden. It has the following
functionalities: disease detection of plants, suggestions for decoration of the garden based on analized data.

The application is developed in Xamarin Forms Framework using as programming language C#(which interprets in Java language
and compile Android project).

> For more details you can see:
> [Demo](https://youtu.be/5G7V_HSD6M0)

## Grafic Interface

The grafic interface consist in the following views:
...
For application testing you can use the following images:
